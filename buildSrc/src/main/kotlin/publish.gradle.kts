        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/bvrch/test/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/bvrch/test.git")
                        developerConnection.set("scm:git:ssh://github.com/bvrch/test.git")
                        url.set("https://github.com/bvrch/test/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/bvrch/test/issues")
                    }
                }
            }
        }
